    ...
    <>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-700">{t('admin.birthDate')}</label>
            <input
              type="date"
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm text-slate-900 focus:border-transparent focus:ring-2 focus:ring-slate-400"
            />
            <p className="mt-1 text-xs text-slate-500">{t('admin.birthDateHint')}</p>
          </div>
          <div>
