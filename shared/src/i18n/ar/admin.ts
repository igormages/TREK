...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'أسعار الفنادق (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'إظهار سعر الليلة على علامات أماكن الإقامة، عبر Hotellook.',
  'admin.travelpayoutsToken': 'رمز واجهة البرمجة',
  'admin.travelpayoutsTokenHint': 'رمز واجهة برمجة Travelpayouts. يُخزَّن مشفَّرًا ولا يُعرض مرة أخرى.',
  'admin.travelpayoutsTokenEnv': 'مضبوط عبر متغير البيئة TRAVELPAYOUTS_TOKEN، وله الأولوية على هذا الحقل.',
  'admin.travelpayoutsMarker': 'معرّف الإحالة',
  'admin.travelpayoutsMarkerHint': 'معرّف الإحالة الرقمي الخاص بك في Travelpayouts.',
  'admin.travelpayoutsSaved': 'تم حفظ إعدادات Travelpayouts',
