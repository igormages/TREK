...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'حسب البلد',
  'budget.perDayByCountry': 'التكلفة اليومية',
  'budget.perDayByCountryHint': 'إجمالي الإنفاق في كل بلد مقسومًا على عدد الأيام التي قضيتها فيه.',
  'budget.allCountries': 'كل البلدان',
  'budget.noCountry': 'بدون بلد',
  'budget.daysShort': 'ي',
  'budget.filterByCountry': 'التصفية حسب هذا البلد',
  'budget.clearCountryFilter': 'إزالة التصفية',
  'budget.noExpenseForCountry': 'لا توجد مصاريف لهذا البلد.',
  ...
  'costs.byCountry': 'حسب البلد',
  'costs.perDayByCountry': 'التكلفة اليومية',
  'costs.perDayByCountryHint': 'إجمالي الإنفاق في كل بلد مقسومًا على عدد الأيام التي قضيتها فيه.',
  'costs.byMonth': 'حسب الشهر',
  'costs.filter.allCountries': 'كل البلدان',
  'costs.daysShort': 'ي',
