...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'ملاحظة',
  'dayplan.notePreview': 'معاينة',
  'dayplan.noteEditText': 'تحرير',
  'dayplan.noteMarkdownHint': 'يدعم Markdown',
  'dayplan.noteCost': 'التكلفة',
  'dayplan.noteShowMore': 'عرض المزيد',
  'dayplan.noteShowLess': 'عرض أقل',
