...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Preços de hotéis (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Exibir a diária nos marcadores de hospedagem, via Hotellook.',
  'admin.travelpayoutsToken': 'Token da API',
  'admin.travelpayoutsTokenHint': 'Token da API do Travelpayouts. Armazenado criptografado e nunca exibido novamente.',
  'admin.travelpayoutsTokenEnv': 'Definido pela variável de ambiente TRAVELPAYOUTS_TOKEN, que tem prioridade sobre este campo.',
  'admin.travelpayoutsMarker': 'Marcador de afiliado',
  'admin.travelpayoutsMarkerHint': 'Seu id numérico de afiliado do Travelpayouts.',
  'admin.travelpayoutsSaved': 'Configurações do Travelpayouts salvas',
