...
const budget: TranslationStrings = {
  ...
  'budget.perDayByCountry': 'Custo por dia',
  'budget.perDayByCountryHint': 'Total gasto em cada país dividido pelos dias passados no local.',
  'budget.allCountries': 'Todos os países',
  'budget.noCountry': 'Sem país',
  'budget.daysShort': 'd',
  'budget.filterByCountry': 'Filtrar por este país',
  'budget.clearCountryFilter': 'Remover o filtro',
  'budget.noExpenseForCountry': 'Nenhuma despesa para este país.',
  ...
  'costs.perDayByCountry': 'Custo por dia',
  'costs.perDayByCountryHint': 'Total gasto em cada país dividido pelos dias passados no local.',
  'costs.byMonth': 'Por mês',
  'costs.filter.allCountries': 'Todos os países',
  'costs.daysShort': 'd',
