...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Preus d\'hotels (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Mostra la tarifa per nit als marcadors d\'allotjament, mitjançant Hotellook.',
  'admin.travelpayoutsToken': 'Testimoni d\'API',
  'admin.travelpayoutsTokenHint': 'Testimoni d\'API de Travelpayouts. Es desa xifrat i no es torna a mostrar.',
  'admin.travelpayoutsTokenEnv': 'Definit per la variable d\'entorn TRAVELPAYOUTS_TOKEN, que té prioritat sobre aquest camp.',
  'admin.travelpayoutsMarker': 'Marcador d\'afiliat',
  'admin.travelpayoutsMarkerHint': 'El teu identificador numèric d\'afiliat de Travelpayouts.',
  'admin.travelpayoutsSaved': 'Configuració de Travelpayouts desada',
