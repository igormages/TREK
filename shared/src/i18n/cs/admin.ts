...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Ceny hotelů (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Zobrazit cenu za noc na značkách ubytování, ze služby Hotellook.',
  'admin.travelpayoutsToken': 'API token',
  'admin.travelpayoutsTokenHint': 'API token Travelpayouts. Uložen šifrovaně a nikdy znovu nezobrazen.',
  'admin.travelpayoutsTokenEnv': 'Nastaveno proměnnou prostředí TRAVELPAYOUTS_TOKEN, která má přednost před tímto polem.',
  'admin.travelpayoutsMarker': 'Partnerský marker',
  'admin.travelpayoutsMarkerHint': 'Vaše číselné partnerské id Travelpayouts.',
  'admin.travelpayoutsSaved': 'Nastavení Travelpayouts uloženo',
