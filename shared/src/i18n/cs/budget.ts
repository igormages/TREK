...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Podle země',
  'budget.perDayByCountry': 'Náklady na den',
  'budget.perDayByCountryHint': 'Celkové výdaje v každé zemi dělené počtem tam strávených dní.',
  'budget.allCountries': 'Všechny země',
  'budget.noCountry': 'Bez země',
  'budget.daysShort': 'd',
  'budget.filterByCountry': 'Filtrovat podle této země',
  'budget.clearCountryFilter': 'Zrušit filtr',
  'budget.noExpenseForCountry': 'Pro tuto zemi nejsou žádné výdaje.',
  ...
  'costs.byCountry': 'Podle země',
  'costs.perDayByCountry': 'Náklady na den',
  'costs.perDayByCountryHint': 'Celkové výdaje v každé zemi dělené počtem tam strávených dní.',
  'costs.byMonth': 'Podle měsíce',
  'costs.filter.allCountries': 'Všechny země',
  'costs.daysShort': 'd',
