...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Hotelpreise (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Übernachtungspreise auf den Unterkunfts-Markern anzeigen, via Hotellook.',
  'admin.travelpayoutsToken': 'API-Token',
  'admin.travelpayoutsTokenHint': 'Travelpayouts-API-Token. Verschlüsselt gespeichert und nie wieder angezeigt.',
  'admin.travelpayoutsTokenEnv': 'Über die Umgebungsvariable TRAVELPAYOUTS_TOKEN gesetzt, die Vorrang vor diesem Feld hat.',
  'admin.travelpayoutsMarker': 'Affiliate-Marker',
  'admin.travelpayoutsMarkerHint': 'Ihre numerische Travelpayouts-Affiliate-ID.',
  'admin.travelpayoutsSaved': 'Travelpayouts-Einstellungen gespeichert',
