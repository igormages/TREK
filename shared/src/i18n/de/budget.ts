...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Nach Land',
  'budget.perDayByCountry': 'Kosten pro Tag',
  'budget.perDayByCountryHint': 'Gesamtausgaben je Land geteilt durch die dort verbrachten Tage.',
  'budget.allCountries': 'Alle Länder',
  'budget.noCountry': 'Ohne Land',
  'budget.daysShort': 'T',
  'budget.filterByCountry': 'Nach diesem Land filtern',
  'budget.clearCountryFilter': 'Filter entfernen',
  'budget.noExpenseForCountry': 'Keine Ausgaben für dieses Land.',
  ...
  'costs.byCountry': 'Nach Land',
  'costs.perDayByCountry': 'Kosten pro Tag',
  'costs.perDayByCountryHint': 'Gesamtausgaben je Land geteilt durch die dort verbrachten Tage.',
  'costs.byMonth': 'Nach Monat',
  'costs.filter.allCountries': 'Alle Länder',
  'costs.daysShort': 'T',
