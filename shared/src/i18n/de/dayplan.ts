...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Notiz',
  'dayplan.notePreview': 'Vorschau',
  'dayplan.noteEditText': 'Bearbeiten',
  'dayplan.noteMarkdownHint': 'Markdown wird unterstützt',
  'dayplan.noteCost': 'Kosten',
  'dayplan.noteShowMore': 'Mehr anzeigen',
  'dayplan.noteShowLess': 'Weniger anzeigen',
