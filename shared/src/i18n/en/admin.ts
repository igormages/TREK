...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Hotel prices (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Show nightly rates on accommodation markers, sourced from Hotellook.',
  'admin.travelpayoutsToken': 'API token',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API token. Stored encrypted and never shown again.',
  'admin.travelpayoutsTokenEnv': 'Set by the TRAVELPAYOUTS_TOKEN environment variable, which takes precedence over this field.',
  'admin.travelpayoutsMarker': 'Affiliate marker',
  'admin.travelpayoutsMarkerHint': 'Your numeric Travelpayouts affiliate id.',
  'admin.travelpayoutsSaved': 'Travelpayouts settings saved',
