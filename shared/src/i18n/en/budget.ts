...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'By Country',
  'budget.perDayByCountry': 'Cost per Day',
  'budget.perDayByCountryHint': 'Total spent in each country divided by the days spent there.',
  'budget.allCountries': 'All countries',
  'budget.noCountry': 'No country',
  'budget.daysShort': 'd',
  'budget.filterByCountry': 'Filter by this country',
  'budget.clearCountryFilter': 'Clear the filter',
  'budget.noExpenseForCountry': 'No expense for this country.',
  ...
  'costs.byCountry': 'By country',
  'costs.perDayByCountry': 'Cost per day',
  'costs.perDayByCountryHint': 'Total spent in each country divided by the days spent there.',
  'costs.byMonth': 'By month',
  'costs.filter.allCountries': 'All countries',
  'costs.daysShort': 'd',
