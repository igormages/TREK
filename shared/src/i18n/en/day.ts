...
const day: TranslationStrings = {
  ...
  'day.workOverlap': 'Work hours overlap',
  'day.workOverlapHint': '{homeRange} at home = {localRange} local time',
  'day.workOverlapNone': 'No overlap with local waking hours (08-23)',
};
export default day;
