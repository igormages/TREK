...
const admin: TranslationStrings = {
  ...
  'admin.birthDate': 'Fecha de nacimiento',
  'admin.birthDateHint': 'Los menores de dos años no cuentan en las búsquedas de alojamiento.',
  ...
  'admin.travelpayoutsTitle': 'Precios de hoteles (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Mostrar la tarifa por noche en los marcadores de alojamiento, mediante Hotellook.',
  'admin.travelpayoutsToken': 'Token de API',
  'admin.travelpayoutsTokenHint': 'Token de API de Travelpayouts. Se guarda cifrado y no se vuelve a mostrar.',
  'admin.travelpayoutsTokenEnv': 'Definido por la variable de entorno TRAVELPAYOUTS_TOKEN, que tiene prioridad sobre este campo.',
  'admin.travelpayoutsMarker': 'Marcador de afiliado',
  'admin.travelpayoutsMarkerHint': 'Tu identificador numérico de afiliado de Travelpayouts.',
  'admin.travelpayoutsSaved': 'Ajustes de Travelpayouts guardados',
