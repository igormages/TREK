...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Por país',
  'budget.perDayByCountry': 'Coste por día',
  'budget.perDayByCountryHint': 'Total gastado en cada país dividido entre los días pasados allí.',
  'budget.allCountries': 'Todos los países',
  'budget.noCountry': 'Sin país',
  'budget.daysShort': 'd',
  'budget.filterByCountry': 'Filtrar por este país',
  'budget.clearCountryFilter': 'Quitar el filtro',
  'budget.noExpenseForCountry': 'No hay gastos para este país.',
  ...
  'costs.byCountry': 'Por país',
  'costs.perDayByCountry': 'Coste por día',
  'costs.perDayByCountryHint': 'Total gastado en cada país dividido entre los días pasados allí.',
  'costs.byMonth': 'Por mes',
  'costs.filter.allCountries': 'Todos los países',
  'costs.daysShort': 'd',
