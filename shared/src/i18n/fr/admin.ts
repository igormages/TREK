...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Prix des hôtels (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Afficher le tarif par nuit sur les pastilles d\'hébergement, via Hotellook.',
  'admin.travelpayoutsToken': 'Jeton d\'API',
  'admin.travelpayoutsTokenHint': 'Jeton d\'API Travelpayouts. Stocké chiffré et jamais réaffiché.',
  'admin.travelpayoutsTokenEnv': 'Défini par la variable d\'environnement TRAVELPAYOUTS_TOKEN, qui prime sur ce champ.',
  'admin.travelpayoutsMarker': 'Identifiant d\'affiliation',
  'admin.travelpayoutsMarkerHint': 'Votre identifiant d\'affilié Travelpayouts (numérique).',
  'admin.travelpayoutsSaved': 'Réglages Travelpayouts enregistrés',
