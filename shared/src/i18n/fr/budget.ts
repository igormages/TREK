...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Par pays',
  'budget.perDayByCountry': 'Coût par jour',
  'budget.perDayByCountryHint': 'Total dépensé dans chaque pays divisé par le nombre de jours passés sur place.',
  'budget.allCountries': 'Tous les pays',
  'budget.noCountry': 'Sans pays',
  'budget.daysShort': 'j',
  'budget.filterByCountry': 'Filtrer sur ce pays',
  'budget.clearCountryFilter': 'Retirer le filtre',
  'budget.noExpenseForCountry': 'Aucune dépense pour ce pays.',
  ...
  'costs.byCountry': 'Par pays',
  'costs.perDayByCountry': 'Coût par jour',
  'costs.perDayByCountryHint': 'Total dépensé dans chaque pays divisé par le nombre de jours passés sur place.',
  'costs.byMonth': 'Par mois',
  'costs.filter.allCountries': 'Tous les pays',
  'costs.daysShort': 'j',
