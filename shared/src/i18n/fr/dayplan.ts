...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Note',
  'dayplan.notePreview': 'Aperçu',
  'dayplan.noteEditText': 'Éditer',
  'dayplan.noteMarkdownHint': 'Markdown pris en charge',
  'dayplan.noteCost': 'Coût',
  'dayplan.noteShowMore': 'Voir plus',
  'dayplan.noteShowLess': 'Voir moins',
