...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Τιμές ξενοδοχείων (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Εμφάνιση τιμής ανά διανυκτέρευση στους δείκτες καταλυμάτων, μέσω Hotellook.',
  'admin.travelpayoutsToken': 'Διακριτικό API',
  'admin.travelpayoutsTokenHint': 'Διακριτικό API του Travelpayouts. Αποθηκεύεται κρυπτογραφημένο και δεν εμφανίζεται ξανά.',
  'admin.travelpayoutsTokenEnv': 'Ορίζεται από τη μεταβλητή περιβάλλοντος TRAVELPAYOUTS_TOKEN, η οποία υπερισχύει αυτού του πεδίου.',
  'admin.travelpayoutsMarker': 'Δείκτης συνεργάτη',
  'admin.travelpayoutsMarkerHint': 'Το αριθμητικό αναγνωριστικό συνεργάτη σας στο Travelpayouts.',
  'admin.travelpayoutsSaved': 'Οι ρυθμίσεις Travelpayouts αποθηκεύτηκαν',
