...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Ανά χώρα',
  'budget.perDayByCountry': 'Κόστος ανά ημέρα',
  'budget.perDayByCountryHint': 'Σύνολο δαπανών σε κάθε χώρα διά τις ημέρες παραμονής εκεί.',
  'budget.allCountries': 'Όλες οι χώρες',
  'budget.noCountry': 'Χωρίς χώρα',
  'budget.daysShort': 'ημ',
  'budget.filterByCountry': 'Φιλτράρισμα για αυτή τη χώρα',
  'budget.clearCountryFilter': 'Καθαρισμός φίλτρου',
  'budget.noExpenseForCountry': 'Δεν υπάρχουν έξοδα για αυτή τη χώρα.',
  ...
  'costs.byCountry': 'Ανά χώρα',
  'costs.perDayByCountry': 'Κόστος ανά ημέρα',
  'costs.perDayByCountryHint': 'Σύνολο δαπανών σε κάθε χώρα διά τις ημέρες παραμονής εκεί.',
  'costs.byMonth': 'Ανά μήνα',
  'costs.filter.allCountries': 'Όλες οι χώρες',
  'costs.daysShort': 'ημ',
