...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Σημείωση',
  'dayplan.notePreview': 'Προεπισκόπηση',
  'dayplan.noteEditText': 'Επεξεργασία',
  'dayplan.noteMarkdownHint': 'Υποστηρίζεται Markdown',
  'dayplan.noteCost': 'Κόστος',
  'dayplan.noteShowMore': 'Περισσότερα',
  'dayplan.noteShowLess': 'Λιγότερα',
