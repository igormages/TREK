...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Szállodaárak (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Éjszakánkénti ár megjelenítése a szállásjelölőkön, a Hotellook alapján.',
  'admin.travelpayoutsToken': 'API token',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API token. Titkosítva tárolva, többé nem jelenik meg.',
  'admin.travelpayoutsTokenEnv': 'A TRAVELPAYOUTS_TOKEN környezeti változó állítja be, amely elsőbbséget élvez ezzel a mezővel szemben.',
  'admin.travelpayoutsMarker': 'Partner azonosító',
  'admin.travelpayoutsMarkerHint': 'Az Ön numerikus Travelpayouts partnerazonosítója.',
  'admin.travelpayoutsSaved': 'Travelpayouts beállítások mentve',
