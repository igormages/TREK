...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Ország szerint',
  'budget.perDayByCountry': 'Napi költség',
  'budget.perDayByCountryHint': 'Az egyes országokban elköltött összeg osztva az ott töltött napok számával.',
  'budget.allCountries': 'Minden ország',
  'budget.noCountry': 'Ország nélkül',
  'budget.daysShort': 'n',
  'budget.filterByCountry': 'Szűrés erre az országra',
  'budget.clearCountryFilter': 'Szűrő törlése',
  'budget.noExpenseForCountry': 'Nincs kiadás ehhez az országhoz.',
  ...
  'costs.byCountry': 'Ország szerint',
  'costs.perDayByCountry': 'Napi költség',
  'costs.perDayByCountryHint': 'Az egyes országokban elköltött összeg osztva az ott töltött napok számával.',
  'costs.byMonth': 'Hónap szerint',
  'costs.filter.allCountries': 'Minden ország',
  'costs.daysShort': 'n',
