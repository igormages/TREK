...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Jegyzet',
  'dayplan.notePreview': 'Előnézet',
  'dayplan.noteEditText': 'Szerkesztés',
  'dayplan.noteMarkdownHint': 'Markdown támogatott',
  'dayplan.noteCost': 'Költség',
  'dayplan.noteShowMore': 'Több megjelenítése',
  'dayplan.noteShowLess': 'Kevesebb megjelenítése',
