...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Harga hotel (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Tampilkan tarif per malam pada penanda akomodasi, melalui Hotellook.',
  'admin.travelpayoutsToken': 'Token API',
  'admin.travelpayoutsTokenHint': 'Token API Travelpayouts. Disimpan terenkripsi dan tidak ditampilkan lagi.',
  'admin.travelpayoutsTokenEnv': 'Diatur oleh variabel lingkungan TRAVELPAYOUTS_TOKEN, yang lebih diutamakan daripada kolom ini.',
  'admin.travelpayoutsMarker': 'Penanda afiliasi',
  'admin.travelpayoutsMarkerHint': 'ID afiliasi Travelpayouts Anda (angka).',
  'admin.travelpayoutsSaved': 'Pengaturan Travelpayouts disimpan',
