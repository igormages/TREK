...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Menurut negara',
  'budget.perDayByCountry': 'Biaya per hari',
  'budget.perDayByCountryHint': 'Total pengeluaran di tiap negara dibagi jumlah hari yang dihabiskan di sana.',
  'budget.allCountries': 'Semua negara',
  'budget.noCountry': 'Tanpa negara',
  'budget.daysShort': 'h',
  'budget.filterByCountry': 'Saring menurut negara ini',
  'budget.clearCountryFilter': 'Hapus filter',
  'budget.noExpenseForCountry': 'Tidak ada pengeluaran untuk negara ini.',
  ...
  'costs.byCountry': 'Menurut negara',
  'costs.perDayByCountry': 'Biaya per hari',
  'costs.perDayByCountryHint': 'Total pengeluaran di tiap negara dibagi jumlah hari yang dihabiskan di sana.',
  'costs.byMonth': 'Menurut bulan',
  'costs.filter.allCountries': 'Semua negara',
  'costs.daysShort': 'h',
