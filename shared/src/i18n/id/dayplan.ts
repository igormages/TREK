...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Catatan',
  'dayplan.notePreview': 'Pratinjau',
  'dayplan.noteEditText': 'Edit',
  'dayplan.noteMarkdownHint': 'Mendukung Markdown',
  'dayplan.noteCost': 'Biaya',
  'dayplan.noteShowMore': 'Tampilkan lebih banyak',
  'dayplan.noteShowLess': 'Tampilkan lebih sedikit',
