...
const admin: TranslationStrings = {
  ...
  'admin.birthDate': 'Data di nascita',
  'admin.birthDateHint': 'I bambini sotto i due anni non contano nelle ricerche di alloggio.',
  ...
  'admin.travelpayoutsTitle': 'Prezzi degli hotel (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Mostra la tariffa per notte sui segnaposti degli alloggi, tramite Hotellook.',
  'admin.travelpayoutsToken': 'Token API',
  'admin.travelpayoutsTokenHint': 'Token API di Travelpayouts. Salvato cifrato e mai più mostrato.',
  'admin.travelpayoutsTokenEnv': 'Impostato dalla variabile d\'ambiente TRAVELPAYOUTS_TOKEN, che ha la precedenza su questo campo.',
  'admin.travelpayoutsMarker': 'Marker di affiliazione',
  'admin.travelpayoutsMarkerHint': 'Il tuo id affiliato Travelpayouts (numerico).',
  'admin.travelpayoutsSaved': 'Impostazioni Travelpayouts salvate',
