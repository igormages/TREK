...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Per paese',
  'budget.perDayByCountry': 'Costo al giorno',
  'budget.perDayByCountryHint': 'Totale speso in ogni paese diviso per i giorni trascorsi sul posto.',
  'budget.allCountries': 'Tutti i paesi',
  'budget.noCountry': 'Senza paese',
  'budget.daysShort': 'g',
  'budget.filterByCountry': 'Filtra per questo paese',
  'budget.clearCountryFilter': 'Rimuovi il filtro',
  'budget.noExpenseForCountry': 'Nessuna spesa per questo paese.',
  ...
  'costs.byCountry': 'Per paese',
  'costs.perDayByCountry': 'Costo al giorno',
  'costs.perDayByCountryHint': 'Totale speso in ogni paese diviso per i giorni trascorsi sul posto.',
  'costs.byMonth': 'Per mese',
  'costs.filter.allCountries': 'Tutti i paesi',
  'costs.daysShort': 'g',
