...
const dayplan: TranslationStrings = {
  ...
  'dayplan.notePreview': 'Anteprima',
  'dayplan.noteEditText': 'Modifica',
  'dayplan.noteMarkdownHint': 'Markdown supportato',
  'dayplan.noteCost': 'Costo',
  'dayplan.noteShowMore': 'Mostra di più',
  'dayplan.noteShowLess': 'Mostra meno',
