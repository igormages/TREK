...
const admin: TranslationStrings = {
  ...
  'admin.birthDateHint': '2歳未満は宿泊施設の検索で人数に含まれません。',
  ...
  'admin.travelpayoutsTitle': 'ホテル料金（Travelpayouts）',
  'admin.travelpayoutsSubtitle': 'Hotellook を利用して、宿泊マーカーに1泊あたりの料金を表示します。',
  'admin.travelpayoutsToken': 'API トークン',
  'admin.travelpayoutsTokenHint': 'Travelpayouts の API トークン。暗号化して保存され、再表示されません。',
  'admin.travelpayoutsTokenEnv': '環境変数 TRAVELPAYOUTS_TOKEN で設定されており、この項目より優先されます。',
  'admin.travelpayoutsMarker': 'アフィリエイトマーカー',
  'admin.travelpayoutsMarkerHint': 'Travelpayouts のアフィリエイト ID（数字）。',
  'admin.travelpayoutsSaved': 'Travelpayouts の設定を保存しました',
