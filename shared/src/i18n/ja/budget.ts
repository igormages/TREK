...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': '国別',
  'budget.perDayByCountry': '1日あたりの費用',
  'budget.perDayByCountryHint': '各国での支出合計を、その国で過ごした日数で割った金額です。',
  'budget.allCountries': 'すべての国',
  'budget.noCountry': '国なし',
  'budget.daysShort': '日',
  'budget.filterByCountry': 'この国で絞り込む',
  'budget.clearCountryFilter': 'フィルターを解除',
  'budget.noExpenseForCountry': 'この国の支出はありません。',
  ...
  'costs.byCountry': '国別',
  'costs.perDayByCountry': '1日あたりの費用',
  'costs.perDayByCountryHint': '各国での支出合計を、その国で過ごした日数で割った金額です。',
  'costs.byMonth': '月別',
  'costs.filter.allCountries': 'すべての国',
  'costs.daysShort': '日',
