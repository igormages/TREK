...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': '호텔 요금 (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Hotellook을 통해 숙소 마커에 1박 요금을 표시합니다.',
  'admin.travelpayoutsToken': 'API 토큰',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API 토큰. 암호화되어 저장되며 다시 표시되지 않습니다.',
  'admin.travelpayoutsTokenEnv': '환경 변수 TRAVELPAYOUTS_TOKEN으로 설정되어 있으며 이 필드보다 우선합니다.',
  'admin.travelpayoutsMarker': '제휴 마커',
  'admin.travelpayoutsMarkerHint': 'Travelpayouts 제휴 ID(숫자)입니다.',
  'admin.travelpayoutsSaved': 'Travelpayouts 설정이 저장되었습니다',
