...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': '국가별',
  'budget.perDayByCountry': '하루 비용',
  'budget.perDayByCountryHint': '각 국가에서 쓴 총액을 그곳에서 보낸 일수로 나눈 값입니다.',
  'budget.allCountries': '모든 국가',
  'budget.noCountry': '국가 없음',
  'budget.daysShort': '일',
  'budget.filterByCountry': '이 국가로 필터',
  'budget.clearCountryFilter': '필터 해제',
  'budget.noExpenseForCountry': '이 국가의 지출이 없습니다.',
  ...
  'costs.byCountry': '국가별',
  'costs.perDayByCountry': '하루 비용',
  'costs.perDayByCountryHint': '각 국가에서 쓴 총액을 그곳에서 보낸 일수로 나눈 값입니다.',
  'costs.byMonth': '월별',
  'costs.filter.allCountries': '모든 국가',
  'costs.daysShort': '일',
