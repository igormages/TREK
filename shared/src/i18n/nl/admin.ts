...
const admin: TranslationStrings = {
  ...
  'admin.birthDateHint': 'Kinderen onder de twee tellen niet mee bij het zoeken naar accommodatie.',
  ...
  'admin.travelpayoutsTitle': 'Hotelprijzen (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Toon de prijs per nacht op de accommodatiemarkers, via Hotellook.',
  'admin.travelpayoutsToken': 'API-token',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API-token. Versleuteld opgeslagen en nooit meer getoond.',
  'admin.travelpayoutsTokenEnv': 'Ingesteld via de omgevingsvariabele TRAVELPAYOUTS_TOKEN, die voorrang heeft op dit veld.',
  'admin.travelpayoutsMarker': 'Affiliate-marker',
  'admin.travelpayoutsMarkerHint': 'Je numerieke Travelpayouts affiliate-id.',
  'admin.travelpayoutsSaved': 'Travelpayouts-instellingen opgeslagen',
