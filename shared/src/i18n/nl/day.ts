...
const day: TranslationStrings = {
  ...
  'day.workOverlap': 'Overlap werkuren',
  'day.workOverlapHint': '{homeRange} thuis = {localRange} lokale tijd',
  'day.workOverlapNone': 'Geen overlap met lokale wakkere uren (08-23)',
};
export default day;
