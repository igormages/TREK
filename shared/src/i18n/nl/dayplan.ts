...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Notitie',
  'dayplan.notePreview': 'Voorbeeld',
  'dayplan.noteEditText': 'Bewerken',
  'dayplan.noteMarkdownHint': 'Markdown wordt ondersteund',
  'dayplan.noteCost': 'Kosten',
  'dayplan.noteShowMore': 'Meer tonen',
  'dayplan.noteShowLess': 'Minder tonen',
