...
const admin: TranslationStrings = {
  ...
  'admin.birthDate': 'Data urodzenia',
  'admin.birthDateHint': 'Dzieci poniżej dwóch lat nie są liczone w wyszukiwaniu noclegów.',
  ...
  'admin.travelpayoutsTitle': 'Ceny hoteli (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Pokazuj cenę za noc na znacznikach noclegów, na podstawie Hotellook.',
  'admin.travelpayoutsToken': 'Token API',
  'admin.travelpayoutsTokenHint': 'Token API Travelpayouts. Przechowywany w postaci zaszyfrowanej i nigdy ponownie niewyświetlany.',
  'admin.travelpayoutsTokenEnv': 'Ustawione zmienną środowiskową TRAVELPAYOUTS_TOKEN, która ma pierwszeństwo przed tym polem.',
  'admin.travelpayoutsMarker': 'Marker partnerski',
  'admin.travelpayoutsMarkerHint': 'Twój numeryczny identyfikator partnera Travelpayouts.',
  'admin.travelpayoutsSaved': 'Zapisano ustawienia Travelpayouts',
