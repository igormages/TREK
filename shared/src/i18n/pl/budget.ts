...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'Według kraju',
  'budget.perDayByCountry': 'Koszt na dzień',
  'budget.perDayByCountryHint': 'Suma wydatków w każdym kraju podzielona przez liczbę spędzonych tam dni.',
  'budget.allCountries': 'Wszystkie kraje',
  'budget.noCountry': 'Bez kraju',
  'budget.daysShort': 'd',
  'budget.filterByCountry': 'Filtruj według tego kraju',
  'budget.clearCountryFilter': 'Wyczyść filtr',
  'budget.noExpenseForCountry': 'Brak wydatków dla tego kraju.',
  ...
  'costs.byCountry': 'Według kraju',
  'costs.perDayByCountry': 'Koszt na dzień',
  'costs.perDayByCountryHint': 'Suma wydatków w każdym kraju podzielona przez liczbę spędzonych tam dni.',
  'costs.byMonth': 'Według miesiąca',
  'costs.filter.allCountries': 'Wszystkie kraje',
  'costs.daysShort': 'd',
