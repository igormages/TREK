...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Notatka',
  'dayplan.notePreview': 'Podgląd',
  'dayplan.noteEditText': 'Edytuj',
  'dayplan.noteMarkdownHint': 'Obsługa Markdown',
  'dayplan.noteCost': 'Koszt',
  'dayplan.noteShowMore': 'Pokaż więcej',
  'dayplan.noteShowLess': 'Pokaż mniej',
