...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Цены на отели (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Показывать цену за ночь на маркерах жилья, по данным Hotellook.',
  'admin.travelpayoutsToken': 'Токен API',
  'admin.travelpayoutsTokenHint': 'Токен API Travelpayouts. Хранится в зашифрованном виде и больше не показывается.',
  'admin.travelpayoutsTokenEnv': 'Задан переменной окружения TRAVELPAYOUTS_TOKEN, которая имеет приоритет над этим полем.',
  'admin.travelpayoutsMarker': 'Партнёрский маркер',
  'admin.travelpayoutsMarkerHint': 'Ваш числовой партнёрский идентификатор Travelpayouts.',
  'admin.travelpayoutsSaved': 'Настройки Travelpayouts сохранены',
