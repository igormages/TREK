...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'По странам',
  'budget.perDayByCountry': 'Расходы в день',
  'budget.perDayByCountryHint': 'Сумма расходов в стране, делённая на число проведённых там дней.',
  'budget.allCountries': 'Все страны',
  'budget.noCountry': 'Без страны',
  'budget.daysShort': 'д',
  'budget.filterByCountry': 'Фильтр по этой стране',
  'budget.clearCountryFilter': 'Снять фильтр',
  'budget.noExpenseForCountry': 'Нет расходов для этой страны.',
  ...
  'costs.byCountry': 'По странам',
  'costs.perDayByCountry': 'Расходы в день',
  'costs.perDayByCountryHint': 'Сумма расходов в стране, делённая на число проведённых там дней.',
  'costs.byMonth': 'По месяцам',
  'costs.filter.allCountries': 'Все страны',
  'costs.daysShort': 'д',
