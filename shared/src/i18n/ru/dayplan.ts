...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Заметка',
  'dayplan.notePreview': 'Предпросмотр',
  'dayplan.noteEditText': 'Редактировать',
  'dayplan.noteMarkdownHint': 'Поддерживается Markdown',
  'dayplan.noteCost': 'Стоимость',
  'dayplan.noteShowMore': 'Показать больше',
  'dayplan.noteShowLess': 'Показать меньше',
