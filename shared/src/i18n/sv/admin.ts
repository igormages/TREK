...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Hotellpriser (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Visa pris per natt på boendemarkörerna, via Hotellook.',
  'admin.travelpayoutsToken': 'API-token',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API-token. Lagras krypterad och visas aldrig igen.',
  'admin.travelpayoutsTokenEnv': 'Anges av miljövariabeln TRAVELPAYOUTS_TOKEN, som har företräde framför detta fält.',
  'admin.travelpayoutsMarker': 'Affiliate-markör',
  'admin.travelpayoutsMarkerHint': 'Ditt numeriska Travelpayouts affiliate-id.',
  'admin.travelpayoutsSaved': 'Travelpayouts-inställningar sparade',
