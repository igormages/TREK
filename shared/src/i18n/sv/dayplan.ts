...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Anteckning',
  'dayplan.notePreview': 'Förhandsvisa',
  'dayplan.noteEditText': 'Redigera',
  'dayplan.noteMarkdownHint': 'Markdown stöds',
  'dayplan.noteCost': 'Kostnad',
  'dayplan.noteShowMore': 'Visa mer',
  'dayplan.noteShowLess': 'Visa mindre',
