...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Otel fiyatları (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Konaklama işaretçilerinde gecelik fiyatı göster, Hotellook üzerinden.',
  'admin.travelpayoutsToken': 'API belirteci',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API belirteci. Şifreli olarak saklanır ve bir daha gösterilmez.',
  'admin.travelpayoutsTokenEnv': 'TRAVELPAYOUTS_TOKEN ortam değişkeni tarafından ayarlanır ve bu alana göre önceliklidir.',
  'admin.travelpayoutsMarker': 'Ortaklık işaretçisi',
  'admin.travelpayoutsMarkerHint': 'Sayısal Travelpayouts ortaklık kimliğiniz.',
  'admin.travelpayoutsSaved': 'Travelpayouts ayarları kaydedildi',
