...
const admin: TranslationStrings = {
  ...
  'admin.birthDate': 'Дата народження',
  'admin.birthDateHint': 'Діти до двох років не враховуються під час пошуку житла.',
  ...
  'admin.travelpayoutsTitle': 'Ціни на готелі (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Показувати ціну за ніч на маркерах житла, за даними Hotellook.',
  'admin.travelpayoutsToken': 'Токен API',
  'admin.travelpayoutsTokenHint': 'Токен API Travelpayouts. Зберігається зашифрованим і більше не показується.',
  'admin.travelpayoutsTokenEnv': 'Задано змінною середовища TRAVELPAYOUTS_TOKEN, яка має пріоритет над цим полем.',
  'admin.travelpayoutsMarker': 'Партнерський маркер',
  'admin.travelpayoutsMarkerHint': 'Ваш числовий партнерський ідентифікатор Travelpayouts.',
  'admin.travelpayoutsSaved': 'Налаштування Travelpayouts збережено',
