...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': 'За країнами',
  'budget.perDayByCountry': 'Витрати на день',
  'budget.perDayByCountryHint': 'Сума витрат у країні, поділена на кількість проведених там днів.',
  'budget.allCountries': 'Усі країни',
  'budget.noCountry': 'Без країни',
  'budget.daysShort': 'д',
  'budget.filterByCountry': 'Фільтр за цією країною',
  'budget.clearCountryFilter': 'Зняти фільтр',
  'budget.noExpenseForCountry': 'Немає витрат для цієї країни.',
  ...
  'costs.byCountry': 'За країнами',
  'costs.perDayByCountry': 'Витрати на день',
  'costs.perDayByCountryHint': 'Сума витрат у країні, поділена на кількість проведених там днів.',
  'costs.byMonth': 'За місяцями',
  'costs.filter.allCountries': 'Усі країни',
  'costs.daysShort': 'д',
