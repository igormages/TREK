...
const dayplan: TranslationStrings = {
  ...
  'dayplan.noteBody': 'Нотатка',
  'dayplan.notePreview': 'Попередній перегляд',
  'dayplan.noteEditText': 'Редагувати',
  'dayplan.noteMarkdownHint': 'Підтримується Markdown',
  'dayplan.noteCost': 'Вартість',
  'dayplan.noteShowMore': 'Показати більше',
  'dayplan.noteShowLess': 'Показати менше',
