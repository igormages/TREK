...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': 'Giá khách sạn (Travelpayouts)',
  'admin.travelpayoutsSubtitle': 'Hiển thị giá mỗi đêm trên điểm đánh dấu chỗ ở, qua Hotellook.',
  'admin.travelpayoutsToken': 'Mã API',
  'admin.travelpayoutsTokenHint': 'Mã API Travelpayouts. Được lưu mã hoá và không hiển thị lại.',
  'admin.travelpayoutsTokenEnv': 'Được đặt bởi biến môi trường TRAVELPAYOUTS_TOKEN, có mức ưu tiên cao hơn trường này.',
  'admin.travelpayoutsMarker': 'Mã liên kết',
  'admin.travelpayoutsMarkerHint': 'ID liên kết Travelpayouts dạng số của bạn.',
  'admin.travelpayoutsSaved': 'Đã lưu cài đặt Travelpayouts',
