...
const admin: TranslationStrings = {
  ...
  'admin.travelpayoutsTitle': '飯店價格（Travelpayouts）',
  'admin.travelpayoutsSubtitle': '透過 Hotellook 在住宿標記上顯示每晚價格。',
  'admin.travelpayoutsToken': 'API 權杖',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API 權杖。加密儲存，不會再次顯示。',
  'admin.travelpayoutsTokenEnv': '由環境變數 TRAVELPAYOUTS_TOKEN 設定，其優先權高於此欄位。',
  'admin.travelpayoutsMarker': '聯盟識別碼',
  'admin.travelpayoutsMarkerHint': '您的 Travelpayouts 數字聯盟 ID。',
  'admin.travelpayoutsSaved': 'Travelpayouts 設定已儲存',
