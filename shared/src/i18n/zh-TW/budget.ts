...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': '依國家',
  'budget.perDayByCountry': '每日花費',
  'budget.perDayByCountryHint': '各國支出總額除以在當地停留的天數。',
  'budget.allCountries': '所有國家',
  'budget.noCountry': '無國家',
  'budget.daysShort': '天',
  'budget.filterByCountry': '以此國家篩選',
  'budget.clearCountryFilter': '清除篩選',
  'budget.noExpenseForCountry': '此國家沒有支出。',
  ...
  'costs.byCountry': '依國家',
  'costs.perDayByCountry': '每日花費',
  'costs.perDayByCountryHint': '各國支出總額除以在當地停留的天數。',
  'costs.byMonth': '依月份',
  'costs.filter.allCountries': '所有國家',
  'costs.daysShort': '天',
