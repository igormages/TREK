...
const admin: TranslationStrings = {
  ...
  'admin.birthDateHint': '两岁以下不计入住宿搜索的人数。',
  ...
  'admin.travelpayoutsTitle': '酒店价格（Travelpayouts）',
  'admin.travelpayoutsSubtitle': '通过 Hotellook 在住宿标记上显示每晚价格。',
  'admin.travelpayoutsToken': 'API 令牌',
  'admin.travelpayoutsTokenHint': 'Travelpayouts API 令牌。加密存储，不会再次显示。',
  'admin.travelpayoutsTokenEnv': '由环境变量 TRAVELPAYOUTS_TOKEN 设置，其优先级高于此字段。',
  'admin.travelpayoutsMarker': '联盟标识',
  'admin.travelpayoutsMarkerHint': '您的 Travelpayouts 数字联盟 ID。',
  'admin.travelpayoutsSaved': 'Travelpayouts 设置已保存',
