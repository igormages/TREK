...
const budget: TranslationStrings = {
  ...
  'budget.byCountry': '按国家',
  'budget.perDayByCountry': '每日花费',
  'budget.perDayByCountryHint': '各国支出总额除以在当地停留的天数。',
  'budget.allCountries': '所有国家',
  'budget.noCountry': '无国家',
  'budget.daysShort': '天',
  'budget.filterByCountry': '按此国家筛选',
  'budget.clearCountryFilter': '清除筛选',
  'budget.noExpenseForCountry': '该国家没有支出。',
  ...
  'costs.byCountry': '按国家',
  'costs.perDayByCountry': '每日花费',
  'costs.perDayByCountryHint': '各国支出总额除以在当地停留的天数。',
  'costs.byMonth': '按月份',
  'costs.filter.allCountries': '所有国家',
  'costs.daysShort': '天',
